...
The list of manually curated Biological Processes are available at: ... 
...
The preferential expression values of Gene Ontology Biological Processes (BP), Molecular Functions (MF), and Cellular Components (CC) for the three reference networks is also provided in the resource, and is available at: ...
