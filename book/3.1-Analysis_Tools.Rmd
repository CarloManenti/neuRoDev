...
plot_eTrace(oli_sce,
            genes = "SOX10",
            expression_enrichment = T,
            main = "SOX10 in oligodendrogenesis")
```
...
An alternative and compact visualization of expression enrichment in both subclasses and stages can be obtained with using the function `plot_eMatrix`. The inputs are listed below, and are the same as. for the `get_eTrace` function:
