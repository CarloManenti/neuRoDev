...
Load reference network objects:
...
<div class="figure">
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig1-1.png" alt="Single-cell dataset UMAP with clusters." width="672" />
...
<div class="figure">
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig2-1.png" alt="Single-cell dataset UMAP colored by stage." width="672" />
...
<div class="figure">
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig3-1.png" alt="Corticogenesis network with mapped clusters." width="672" />
...
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig4-1.png" alt="Annotation scores across clusters." width="672" />
...
<div class="figure" style="text-align: center">
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig5-1.png" alt="Single-cell dataset UMAP with clusters and annotations." width="50%" /><img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig5-2.png" alt="Single-cell dataset UMAP with clusters and annotations." width="50%" />
...
<div class="figure" style="text-align: center">
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig6-1.png" alt="Preferential genes expression" width="50%" /><img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig6-2.png" alt="Preferential genes expression" width="50%" /><img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig6-3.png" alt="Preferential genes expression" width="50%" /><img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig6-4.png" alt="Preferential genes expression" width="50%" /><img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig6-5.png" alt="Preferential genes expression" width="50%" /><img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig6-6.png" alt="Preferential genes expression" width="50%" />
...
<div class="figure" style="text-align: center">
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig7-1.png" alt="Heatmap of corticogenesis-specific GO biological processes in resource and mapped clusters." width="99%" />
...
<div class="figure" style="text-align: center">
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig8-1.png" alt="Heatmap of neurogenesis-specific GO biological processes in resource and mapped clusters." width="85%" />
...
<div class="figure" style="text-align: center">
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig9-1.png" alt="VIM and SYT1 eTrace in corticogenesis and mapped points" width="50%" /><img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig9-2.png" alt="VIM and SYT1 eTrace in corticogenesis and mapped points" width="50%" />
...
``` r
sort(apply(table(sc_seu$age, paste0('c', sc_seu$seurat_clusters)), 2, function(i) {i/sum(i)})['Organoid-4M',]*100)
#>        c12        c13        c17        c20        c21 
...
We can also obtain markers for each cluster using the Seurat function `FindAllMarkers` and plot those genes in the eTraces. We selected the first 4 clusters to show this. 
...
<img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig10-1.png" alt="eTraces of clusters 1 and 2 markers." width="48%" /><img src="4.1.1-Mapping_scRNAseq_files/figure-html/ch4-fig10-2.png" alt="eTraces of clusters 1 and 2 markers." width="48%" />
<p class="caption">(\#fig:ch4-fig10)eTraces of clusters 1 and 2 markers.</p>
</div>
