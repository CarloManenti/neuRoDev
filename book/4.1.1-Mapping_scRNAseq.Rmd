...
```{r ch4-fig10, message=FALSE, warning=FALSE, fig.show='hold', fig.align='left', out.width='48%', eval=T, echo=FALSE, fig.cap="eTraces of clusters 1 and 2 markers."}
plot_eTrace(net = corticogenesis_sce, 
                    genes = genes_markers[[1]], 
                    main = paste("markers of cluster",names(markers)[[1]]))
plot_eTrace(net = corticogenesis_sce, 
                    genes = genes_markers[[2]], 
                    main = paste("markers of cluster",names(markers)[[2]]))
```
