...
First, we need to obtain the UMAP plot of the network, which is build upon the correlations to the reference signatures. To color the clusters we can provide the labels and their associated color, thus making possible to visualize any kind of label.  
...
**plotNetworkScore** by default shows the absolute expression level, but it can visualize any numerical vector across the network, including relative expression. The absolute value can be displayed as either raw or smoothed, which consideres the network structure (leads to more homogeneous values between clusters in the same neighborhood). 
The inputs are:
  ...
  - `label_attr` = the column used to define the annotations used to label the plot. Defaults to "SubClass".
  - `smooth` = whether to smooth or not the values based on the network structure. Defaults to TRUE
...
```{r ch2-fig10, fig.cap="OLIG1 preferential expression in gliogenesis."}
plotNetworkScore(net = gliogenesis_sce,
                 genes = 'OLIG1',
...
```{r ch2-fig12, echo =F, fig.width=2.5, fig.height=5, fig.align="center"}
...
```{r ch2-fig13, fig.cap="Corticogenesis subclasses proportions.", fig.width=15, fig.height=4}
...
```{r ch2-fig14, echo =F, fig.width=2.5, fig.height=5, fig.align="center"}
...
```{r ch2-fig15, fig.cap="Neurogenesis subclasses proportions.", fig.width=15, fig.height=4}
...
```{r ch2-fig16, echo =F, fig.width=2.5, fig.height=5, fig.align="center"}
...
```{r ch2-fig17, fig.cap="Gliogenesis Subclasses proportions.", fig.width=15, fig.height=4}
...
```{r ch2-fig18, fig.cap="Corticogenesis cumulative sum of subclasses cells in time.", fig.height=3, fig.width=6, echo=TRUE, include =F}
par(mar=c(4.2,3,1,1))
...
```{r ch2-fig19, fig.cap="Corticogenesis cumulative sum of subclasses cells in time.", fig.height=3, fig.width=6, echo=F}
par(mar=c(4.2,3,1,1))
plot(corticogenesis_subclass_cumsum[1,], 
     type = 'l',
     las = 1,
...
```{r ch2-fig20, fig.cap="Neurogenesis cumulative sum of subclasses cells in time.", fig.height=3, fig.width=6, echo=TRUE, include = F}
par(mar=c(4.2,3,1,1))
...
```{r ch2-fig21, fig.cap="Neurogenesis cumulative sum of subclasses cells in time.", fig.height=3, fig.width=6, echo=F}
par(mar=c(4.2,3,1,1))
plot(neurogenesis_subclass_cumsum[1,], 
     type = 'l', 
     las = 1,
...
```{r ch2-fig22, fig.cap="Gliogenesis cumulative sum of subclasses cells in time.", fig.height=3, fig.width=6, echo=TRUE, include=FALSE}
par(mar=c(4.2,3,1,1))
...
```{r ch2-fig23, fig.cap="Gliogenesis cumulative sum of subclasses cells in time.", fig.height=3, fig.width=6, echo=F}
par(mar=c(4.2,3,1,1))
plot(gliogenesis_subclass_cumsum[1,], 
     type = 'l',
     las = 1,
...
```{r ch2-fig24, fig.cap="Corticogenesis subclasses proportions.", fig.width=7, fig.height=3}
...
```{r ch2-fig25, fig.cap="Neurogenesis subclasses proportions.", fig.width=7, fig.height=3}
...
```{r ch2-fig26, fig.cap="Gliogenesis subclasses proportions.", fig.width=7, fig.height=3}
