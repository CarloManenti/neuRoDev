...
plotNetwork(net = corticogenesis_sce, label_attr = 'Stages')
plotNetwork(net = neurogenesis_sce, label_attr = 'Stages')
plotNetwork(net = gliogenesis_sce, label_attr = 'Stages')
