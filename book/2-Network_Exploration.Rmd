...
The data used can be downloaded here. If someone wants to start from the count matrices, we have stored them as a unique matrix here and the associated metadata here.
