...
```{r ch3-fig3, fig.cap="Gene set eTrace in corticogenesis.", out.width='90%'}
plot_eTrace(corticogenesis_sce, 
            genes = corticogenesis_pe_genes$Oligo, 
            main = 'Oligodendrocyte preferentially expressed genes')
```

```{r ch3-fig4, fig.cap="Genes set expression enrichment eTrace in corticogenesis.", out.width='90%'}
plot_eTrace(corticogenesis_sce, 
